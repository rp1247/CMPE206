...
int main (int argc, char **argv)
{
  ...
  cmd.Parse (argc, argv);
  std::ofstream plotFile ("wifi_cw_Expt.plt");
  GnuplotCollection gnuplots ("wifi_cw_Expt.pdf");
  Gnuplot plot;
  ...
  for(uint32_t cwExpMax = 6; cwExpMax <= 8; cwExpMax++){
	...
	std::cout << cwMin << "    " << cwMax << "   ";
        double avgTput = experiment(false, wifiManager, cwMin, cwMax);
